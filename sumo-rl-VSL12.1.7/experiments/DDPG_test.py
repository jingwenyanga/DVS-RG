...
if __name__ == "__main__":
    ...
    config.rollouts(num_rollout_workers=7,batch_mode='complete_episodes')   # num_rollout_workers=14, create_env_on_local_worker=True,
    ...
    tuner = tune.Tuner(
        ...
        run_config=air.RunConfig(stop={"training_iteration": 200},
